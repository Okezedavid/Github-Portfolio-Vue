...
export default {
  ...
  methods: {
    fetchData: function () {
      this.loading = true;
      fetch(`https://api.github.com/repos/Okezedavid/${this.$route.params.id}`, {
        headers: {
      ...
      fetch(`https://api.github.com/repos/Okezedavid/${this.$route.params.id}/branches`, {
        headers: {
          Accept: 'application/json',
        },
      })
      ...
      fetch(`https://api.github.com/repos/Okezedavid/${this.$route.params.id}/deployments`, {
        headers: {
          Accept: 'application/json',
        },
      })
